      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form className="d-flex">
         ...
         <input className="form-check-input" onClick={props.togglemode} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
          <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{props.tgltext}</label>
          </div>
         ...
         <input className="form-check-input" onClick={props.togglemode2} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
          <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{props.tgltext2}</label>
          </div>
          <div className={`form-check form-switch text-${ props.mode ==='light'?'#ffc107':'light'}`}>
         <input className="form-check-input" onClick={props.togglemode3} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
          <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{props.tgltext3}</label>
          </div> */}
        </form>
      </div>
    </div>
